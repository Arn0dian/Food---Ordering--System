...
<head>
    ...
    <title> Explore | Food Spicilla </title>
</head>
...
if (isset($_SESSION['login_user2'])) {
  ?>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food
                            Zone </a></li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="css/images/slide001.jpg" style="width:100%;">
            ...
            <div class="item">
                <img src="css/images/slide002.jpg" style="width:100%;">
                <div class="carousel-caption">

                </div>
            </div>
            <div class="item">
                <img src="css/images/slide003.jpg" style="width:100%;">
                <div class="carousel-caption">
                </div>
            </div>
